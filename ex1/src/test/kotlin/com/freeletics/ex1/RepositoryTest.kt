...
class RepositoryTest {
    ...
    fun loadPersons() {
        ...
        val msg = "Expected search results: [" + backend.search("Franz").niceString() + "] and [" + backend.search("Thom").niceString() + "] but got the following search results: " + subscriber.values().niceStringList()
        Assert.assertEquals(
